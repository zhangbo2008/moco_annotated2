...
def atest(net, memory_data_loader, test_data_loader, epoch, args):
    net.eval()
...
for epoch in range(epoch_start, args.epochs + 1):
    ...
    test_acc_1 = atest(model.encoder_q, memory_loader, test_loader, epoch, args)
